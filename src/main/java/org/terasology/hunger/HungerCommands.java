...
public class HungerCommands extends BaseComponentSystem {
     ...
     */
    @Command(shortDescription = "Checks your hunger/food level.", runOnServer = true, requiredPermission =
     ...
     *
     * @param newFood The new hunger level for the client. This has to be above 0 and below the max food
     *         capacity.
     ...
     */
    @Command(shortDescription = "Sets your current hunger level.", runOnServer = true, requiredPermission =
            PermissionManager.CHEAT_PERMISSION)
